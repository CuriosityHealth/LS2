...
PARTICIPANT_ACCOUNT_GENERATOR_RATE_LIMIT_WINDOW_MINUTES = int(environ.get('PARTICIPANT_ACCOUNT_GENERATOR_RATE_LIMIT_WINDOW_MINUTES', 5))
PARTICIPANT_ACCOUNT_GENERATOR_RATE_LIMIT_TIMEOUT_MINUTES = int(environ.get('PARTICIPANT_ACCOUNT_GENERATOR_RATE_LIMIT_TIMEOUT_MINUTES', 30))
PARTICIPANT_ACCOUNT_GENERATOR_OBFUSCATE_TOKENS = environ.get('PARTICIPANT_ACCOUNT_GENERATOR_OBFUSCATE_TOKENS', True)
